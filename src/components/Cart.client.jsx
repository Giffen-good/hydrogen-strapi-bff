  ...
  return (
    <div>
      ...
      <Dialog open={isCartOpen} onClose={closeCart}>
        ...
        <div
          className={`absolute flex flex-col md:block z-20 top-0 left-0 right-0 bottom-0 md:top-[.5rem] h-full md:left-auto md:right-[1.85rem] md:bottom-auto md:h-auto md:max-h-[calc(100vh-56px)] bg-gray-50 w-full md:w-[470px] rounded-b-lg shadow-2xl ${
