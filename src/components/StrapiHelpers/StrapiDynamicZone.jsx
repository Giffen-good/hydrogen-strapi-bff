...
function DynamicStrapiComponent({component}) {
  ...
  if (
    ...
    const settings = {
      transition: a.animation,
      threshold: a.animation_threshold,
      trigger_once: a.trigger_animation_once,
      duration: a.animation_duration,
      anchor_link: a.anchor_link,
    };
    return (
  ...
  if (component.componentProps?.component_settings) {
    ...
    return (
      <StrapiBackgroundColor
        remove_section_padding={a.remove_section_padding}
        classes={component.formattedComponentName}
