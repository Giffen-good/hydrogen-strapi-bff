  ...
  return (
    <>
      <div className="relative">
        ...
        <div
          className={`shopping-badge text-xs rounded-full leading-none text-white absolute bottom-3 right-1 flex items-center justify-center transform translate-y-1/2 transition-all ${
